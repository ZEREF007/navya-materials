...
export const collabAreas: CollabArea[] = [
  ...
  },
  {
    ...
    body: "Co-develop products with brands and fabricators using locally-sourced, biodegradable inputs.",
    icon: Factory,
  },
  {
